...
lsap_dates = [
    '2009-03-05', '2009-05-07', '2009-08-06', '2009-11-05',
    '2011-10-06','2012-02-09', '2012-07-05', '2016-08-04', '2020-03-26',
    '2020-11-05','2020-06-18', '2022-02-03', '2022-09-22'
]
...
data['EI_Log_Change'] = np.log(data['BEI'] / data['BEI'].shift(1))
...
required_columns = ['MXWO_Log_Return', 'VIX_Log_Return', 'LSAP_Dummy', 'Brent_Log_Return','GBP/USD_Log_Return']
...
X = filtered_data[['GBP/USD_Log_Return','EI_Log_Change','MXWO_Log_Return', 'VIX_Log_Return', 'LSAP_Dummy',]]
...
variables = ['EI_Log_Change', 'MXWO_Log_Return', 'VIX_Log_Return', 'GBP/USD_Log_Return']
